...
/*
sched： 更改 task_struct：：state
更改 task_struct：：state 的类型和名称。删除 volatile 和
将其收缩为 'unsigned int'。重命名它以查找所有用法
这样我们就可以适当地使用 READ_ONCE/WRITE_ONCE。
*/